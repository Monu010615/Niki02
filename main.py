...
async def txt_handler(bot: Client, m: Message):  
    ...
    if raw_text4 == '/d':
        ...
        cptoken = "eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..nejjpHnduMM5nybjlfmOFqABuFePRY_0XpqBpLrobEgQPsIomwsDUwKF05lRQB65"
        pwtoken = "pwtoken"
    else:
        cwtoken = raw_text4
        cptoken = raw_text4
